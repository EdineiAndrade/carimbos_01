...
for index, row in df.iterrows():
    ...
    if n_parcelas == 1:
         text_periodicidade = text_periodicidade.replace('is','l')
         text_parcelas = f'1 (uma) parcela {text_periodicidade}'
    elif n_parcelas == 2:
    ...
    for i, paragraph in enumerate(modelo_word.paragraphs):
            ...
            if i == 0:
                reembolso_atual = reembolso_atual.replace(';','.')
    ...
    time.sleep(1)
    convert(f'{pasta_carimbo}\{cliente}.docx', f'{pasta_carimbo}\{cliente}.pdf')
